...
async function recentlySold(){
  try {
    ...
    for (i = 0; i < restrictedToRecentEightSalesArray.length; i++) {
      ...
      $('#soldCardButton' + tokenAddress + id).html(`<a href="../client/token.html?token=`+tokenAddress+id+`"><button class="btn btn-light view-btn">View</button></a>`);
...
function soldCardShareOptions(tokenAddress, id){
  ...
  let tokenPage = `../client/token.html?token=${tokenAddress+id}`;
  ...
  try{
    ...
    for (i = 0; i < ifOfferDetailsLength; i++) {
      if(ifOfferDetailsDuplicatesRemoved[i].active == true && ifOfferDetailsDuplicatesRemoved[i].isSold == false){
        ...
        $('#button' + tokenAddress + id).html(`<a href="../client/token.html?token=`+tokenAddress+id+`"><button class="btn btn-primary buy-btn">Buy</button></a>`);
      }
      darkmodeForDynamicContent();
    }
  } catch (error){
  ...
  try{
    ...
    for (i = 0; i < inactiveArtwork.length; i++) {
      if(inactiveArtwork[i].active == false){
        ...
        $('#button' + tokenAddress + id).html(`<a href="../client/token.html?token=`+tokenAddress+id+`"><button class="btn btn-light view-btn">View</button></a>`);
...
function transferToken(tokenAddress, id){
  $('#transferTokenBtn' + tokenAddress + id).click(async()=>{
    ...
    try{
      ...
      $('#owner' + tokenAddress + id).attr('href', "../client/profile.html?address=" + toAddress);
                      ...
                      <div id="soldCard`+tokenAddress+id+`" class="card sold-item shadow-sm">
                        <div class="top-row">
                          <div class="creator-photo">
                            <a href="../client/profile.html?address=`+owner+`"><img loading="lazy" class="owner shadow-sm" id="soldCardOwnerPhoto`+tokenAddress+id+`" src="" width="40" alt="owner photo">
                        ...
                        <div class="embed-responsive embed-responsive-1by1">
                          <a href="../client/token.html?token=`+tokenAddress+id+`">
                        ...
                        <div class="card-body">
                          <a class="anchor" href="../client/token.html?token=`+tokenAddress+id+`">
...
function cardDiv(tokenAddress, id, owner){
  let nftCard = `<div id="nftCard`+tokenAddress+id+`" class="grid-helper col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <div id="card`+tokenAddress+id+`" class="card minted-item shadow-sm">
                      <div class="top-row">
                        <div class="creator-photo">
                          <a id='owner`+tokenAddress+id+`' href="../client/profile.html?address=`+owner+`"><img loading="lazy" class="owner shadow-sm" id="ownerPhoto`+tokenAddress+id+`" src="" width="40" alt="owner photo">
