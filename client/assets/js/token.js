...
function transferToken(tokenAddress, id){
  $('#transferTokenBtn' + tokenAddress + id).click(async()=>{
    ...
    try{
      ...
      $('#ownerNameAnchor' + tokenAddress + id).attr('href', "http://localhost:8000/client/profile.html?address=" + toAddress);
...
async function buy(tokenAddress, id, price, royalty, creator){
  $('#buy' + tokenAddress + id).click(async function(){
    if(user){
      ...
      await CryptoRMarketplaceInstance.methods.buyArt(id, tokenAddress).send({from: ethereum.selectedAddress, value: price}, (err, txHash) => {
        if(err){
          alert(err.message);
                  ...
                  <div class="info-section">
                    ...
                    <div class="top-row-token-page">
                      <div class="owner-div row">
                        <div class="owner-photo">
                          <a class="anchor" id='owner`+tokenAddress+id+`' href="http://localhost:8000/client/profile.html?address=`+owner+`"><img loading="lazy" class="owner shadow-sm" id="ownerPhoto`+tokenAddress+id+`" src="" width="40" alt="creator photo">
                        ...
                        <div class="name">
                          <a class="anchor" id="ownerNameAnchor`+tokenAddress+id+`" href="http://localhost:8000/client/profile.html?address=`+owner+`">
                    ...
                    <div class="creator-div row">
                      <div class="creator-photo">
                        <a class="anchor" href="http://localhost:8000/client/profile.html?address=`+creator+`"><img loading="lazy" class="creator shadow-sm" id="creatorPhoto`+tokenAddress+id+`" src="" width="40" alt="creator photo">
                      ...
                      <div class="name">
                        <a class="anchor" href="http://localhost:8000/client/profile.html?address=`+creator+`">
