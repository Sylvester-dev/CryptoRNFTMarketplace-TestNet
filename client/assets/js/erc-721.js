...
async function uploadToDB(tokenId, nftMetadataPath, nftPath){
  ...
  try {
    ...
    if($('#onSaleSwitch').prop('checked')){
      ...
      $('#successfulText').html('<a href="../client/profile.html?address='+user.attributes.ethAddress+'">Click here to view.</a> <a href="erc-721.html">Or click here to make another one.</a>');
    }
